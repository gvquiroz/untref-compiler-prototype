...
declaracion: VAR_NAME AS TYPE_NUMBER  { addNode($2, T_NUMBER); }
           | VAR_NAME AS TYPE_BOOLEAN { addNode($2, T_BOOLEAN); }
           | VAR_NAME AS TYPE_STRING  { addNode($2, T_STRING); }

asignacion: VAR_NAME ASSIGN NUMBER    {
